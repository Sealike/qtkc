...
//    closeBtn->setText(tr("X"));
    closeBtn->setText(tr("确定"));
    closeBtn->setFixedSize(2*BTN_SIZE, BTN_SIZE);
...
//    delBtn->setText(tr("D"));
    ...
    // 填加数字键盘
    btn1 = new QPushButton(numberWindow);
    btn1->setText(tr("1"));
    btn1->setProperty("num", true);
    btn1->setFixedSize(3*BTN_SIZE, BTN_SIZE);

    btn2 = new QPushButton(numberWindow);
    btn2->setText(tr("2"));
    btn2->setProperty("num", true);
    btn2->setFixedSize(3*BTN_SIZE, BTN_SIZE);

    btn3 = new QPushButton(numberWindow);
    btn3->setText(tr("3"));
    btn3->setProperty("num", true);
    btn3->setFixedSize(3*BTN_SIZE, BTN_SIZE);

    btn4 = new QPushButton(numberWindow);
    btn4->setFixedSize(3*BTN_SIZE, BTN_SIZE);
    btn4->setProperty("num", true);
    btn4->setText(tr("4"));

    btn5 = new QPushButton(numberWindow);
    btn5->setFixedSize(3*BTN_SIZE, BTN_SIZE);
    btn5->setProperty("num", true);
    btn5->setText(tr("5"));

    btn6 = new QPushButton(numberWindow);
    btn6->setFixedSize(3*BTN_SIZE, BTN_SIZE);
    btn6->setProperty("num", true);
    btn6->setText(tr("6"));

    btn7 = new QPushButton(numberWindow);
    btn7->setFixedSize(3*BTN_SIZE, BTN_SIZE);
    btn7->setProperty("num", true);
    btn7->setText(tr("7"));

    btn8 = new QPushButton(numberWindow);
    btn8->setFixedSize(3*BTN_SIZE, BTN_SIZE);
    btn8->setProperty("num", true);
    btn8->setText(tr("8"));

    btn9 = new QPushButton(numberWindow);
    btn9->setFixedSize(3*BTN_SIZE, BTN_SIZE);
    btn9->setProperty("num", true);
    btn9->setText(tr("9"));

    btn0 = new QPushButton(numberWindow);
    btn0->setFixedSize(BTN_SIZE, 3*BTN_SIZE);
    ...
    numberLayout->addWidget(btn0, 0,0,3,1);
    numberLayout->addWidget(btn1, 0,1,1,3);
    numberLayout->addWidget(btn2, 0,4,1,3);
    numberLayout->addWidget(btn3, 0,7,1,3);
    numberLayout->addWidget(btn4, 1,1,1,3);
    numberLayout->addWidget(btn5, 1,4,1,3);
    numberLayout->addWidget(btn6, 1,7,1,3);
    numberLayout->addWidget(btn7, 2,1,1,3);
    numberLayout->addWidget(btn8, 2,4,1,3);
    numberLayout->addWidget(btn9, 2,7,1,3);
    ...
    numberWindow->setLayout(numberLayout);


    qDebug() << "numberlayout ok";
    ...
    letterLayout->addWidget(btnA,1,0,1,1);
    letterLayout->addWidget(btnB,2,5,1,1);
    letterLayout->addWidget(btnC,2,3,1,1);
    letterLayout->addWidget(btnD,1,2,1,1);
    letterLayout->addWidget(btnE,0,2,1,1);
    letterLayout->addWidget(btnF,1,3,1,1);
    letterLayout->addWidget(btnG,1,4,1,1);
    letterLayout->addWidget(btnH,1,5,1,1);
    letterLayout->addWidget(btnI,0,7,1,1);
    letterLayout->addWidget(btnJ,1,6,1,1);
    letterLayout->addWidget(btnK,1,7,1,1);
    letterLayout->addWidget(btnL,1,8,1,1);
    ...
    letterLayout->addWidget(btnS,1,1,1,1);
    ...
    letterLayout->addWidget(styleBtn, 2,8,1,2);
    // 设置行和列间距
...
//    infoLabel->setText(tr(""));
    ...
    signLayout->addWidget(btnSign0,0,0,1,2);
    signLayout->addWidget(btnSign1,0,2,1,2);
    signLayout->addWidget(btnSign2,0,4,1,2);
    signLayout->addWidget(btnSign3,0,6,1,2);
    signLayout->addWidget(btnSign4,0,8,1,2);
    signLayout->addWidget(btnSign5,1,0,1,2);
    signLayout->addWidget(btnSign6,1,2,1,2);
    signLayout->addWidget(btnSign7,1,4,1,2);
    signLayout->addWidget(btnSign8,1,6,1,2);
    signLayout->addWidget(btnSign9,1,8,1,2);
    signLayout->addWidget(btnSign10,2,0,1,2);
    signLayout->addWidget(btnSign11,2,2,1,2);
    signLayout->addWidget(btnSign12,2,4,1,2);
//    signLayout->addWidget(infoLabel,2,6,1,4,Qt::AlignCenter);
    ...
    layout->addWidget(typeBtn,  0,10,1,2);
    layout->addWidget(delBtn,   1,10,1,2);
    layout->addWidget(closeBtn, 2,10,1,2);
    layout->addWidget(keyWindow,0,0,3,10);
